                ...
                <form className="row mt-5 align-items-center">
                    <div className='col-lg-6 mt-5'>
                        <div>
                            ...
                            <iframe className="img-fluid border mt-lg-0 mt-3 shadow" style={{ width: "500px", height: "400px" }} src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d1523.401717566166!2d58.34870495707465!3d37.901400452990146!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x9b88db95a44941de!2sSere!5e1!3m2!1sen!2sus!4v1619180690015!5m2!1sen!2sus" allowFullScreen="" loading="lazy"></iframe>
                        </div>
                    </div>
                    <div className='col-lg-6 mt-5'>
                        <div className="row">
                            ...
                            <div className="col-md-6 mb-3">
                                <div className="form-group">
                                    <input type="text" className="form-control valid rounded-0" name="name" placeholder="Doly adyňyz" aria-required="true" aria-invalid="false" required autoComplete='off' />
                                </div>
                            </div>
                            <div className="col-md-6 mb-3">
                                <div className="form-group">
                                    <input type="email" className="form-control error rounded-0" name="email" placeholder="Email Salgynyň" aria-required="true" aria-invalid="true" required autoComplete='off' />
                                </div>
                            </div>
                            <div className="col-md-12 mb-3">
                                <div className="form-group">
                                    <input type="text" className="form-control valid rounded-0" name="subject" placeholder="Temaňyz" aria-required="true" aria-invalid="false" required autoComplete='off' />
                                </div>
                            </div>
                            <div className="col-md-12 mb-3">
                                <div className="form-group">
                                    <textarea name="comment" className="form-control valid rounded-0" cols="30" rows="4" placeholder="Teswiriňiz" aria-required="true" aria-invalid="false" required></textarea>
                                </div>
                            </div>
                            <div className="col-md-12">
                                <div className="form-group d-grid">
                                    <button type="submit" className="btn btn-dark mt-3 px-5" style={{ borderRadius: "30px" }}>Ugrat</button>
                                </div>
                            </div>
                        </div>
                    </div>
